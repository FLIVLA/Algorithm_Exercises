...
means losing its fractional part. For example, 8.345 would be 
...
then return 2^31 - 1, and if the quotient is strictly 
...
dti = DivideTwoIntegers()
print(dti.divide(7, -3))